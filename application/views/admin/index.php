 ...
 ?> </div>
            ...
            <div class="col-auto">
              <a href="<?= base_url('buku'); ?>">
                <i class="fas fabook fa-3x text-primary"></i>
              </a>
            </div>
          </div>
        </div>
...
<?php 
	...
	?> </div>
            ...
            <div class="col-auto">
              <a href="
								<?= base_url('user'); ?>">
                <i class="fas fauser-tag fa-3x text-success"></i>
              </a>
            </div>
          </div>
        </div>
...
<?php
	...
	?> </div>
            ...
            <div class="col-auto">
              <a href="
								<?= base_url('user'); ?>">
                <i class="fas fashopping-cart fa-3x text-danger"></i>
              </a>
            </div>
          </div>
        </div>
...
base_url('user/data_user'); ?>">
          <i class="fas fa-search mt-2 floatright"> Tampilkan</i>
        </a>
      </div>
