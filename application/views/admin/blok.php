...
<html lang="en">
  <head>
    ...
    <link href="
								<?= base_url('assets/');?>vendor/fontawesomefree/css/all.min.css" rel="stylesheet" type="text/css">
        ...
        <div id="content">
          ...
          <div class="container-fluid mt-5">
            ...
            <div class="text-center">
              ...
              <a href="
																<?= base_url('user');?>">&larr; Kembali ke Dashboard </a>
            </div>
          </div>
          <!-- /.container-fluid -->
        </div>
...
base_url('assets/');?>vendor/bootstrap/js/bootstrap.bundle.min.js">
      < /script> < !--Core plugin JavaScript-- > < script src = " < ? = base_url('assets/'); ? > vendor / jqueryeasing / jquery.easing.min.js ">
    </script>
